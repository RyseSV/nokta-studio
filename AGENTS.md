...
## Autenticación descartada

Por decisión explícita del usuario, Touch ID, Face ID y el bloqueo automático por inactividad se retiraron porque no funcionaban. No reintroducirlos ni tratarlos como funciones pendientes sin una nueva solicitud del usuario.
